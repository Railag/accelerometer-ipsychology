...
public class AttentionDistributionResultsFragment extends SimpleFragment implements ResultScreen {

    public final static String RESULTS = "results";

    public static AttentionDistributionResultsFragment newInstance(Bundle args) {

        AttentionDistributionResultsFragment fragment = new AttentionDistributionResultsFragment();
